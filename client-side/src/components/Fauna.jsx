...
import tuna       from '../assets/fauna/Ikan Tuna Sirip Kuning (Thunnus Albacares).webp'
import kurisi     from '../assets/fauna/IKAN KURISI(Threadfin Bream).webp'
import hiuMartil  from '../assets/fauna/Hiu Martil (Hammerhead Shark).webp'
import pausPilot  from '../assets/fauna/Paus pilot (Globicephala).webp'
import barracuda  from '../assets/fauna/Great Barracuda (Sphyraena barracuda).webp'
import blackfin   from '../assets/fauna/Blackfin Barracuda (Sphyraena qenie).webp'
import bandedKrait from '../assets/fauna/Banded Sea Krait (Laticaudacolubrina).webp'
import oliveSnake from '../assets/fauna/Olive Sea Snake.webp'
import ikanBadut  from '../assets/fauna/Ikan Badut atau Ikan Giru (Genus Amphiprion).webp'
import butterfly  from '../assets/fauna/Ikan Kepe-kepe (Butterflyfish).webp'
import mandarin   from '../assets/fauna/Ikan Mandarin (Synchiropus splendidus).webp'
import sersan     from '../assets/fauna/Ikan Sersan (Pomacentridae).webp'
import singa      from '../assets/fauna/Ikan Singa (Lionfish).webp'
import triggerfish from '../assets/fauna/Ikan Triggerfish Hitam.webp'
import penyuHijau from '../assets/fauna/Penyu Hijau (Chelonia mydas).webp'
...
const faunaData = [
  ...
  { img: bandedKrait, name: 'Banded Sea Krait (Laticauda colubrina)',      desc: 'Ular laut berkepala hitam dengan bibir dan moncong berwarna kuning yang memanjang ke belakang mata.', 
    info:'Kepala ular laut bibir kuning berwarna hitam, dengan lubang hidung lateral dan sisik rostral yang tidak terbagi . Bibir atas dan moncongnya berwarna kuning, dan warna kuning tersebut memanjang ke belakang di setiap sisi kepala di atas mata hingga sisik temporal.' },
  ...
  { img: triggerfish, name: 'Ikan Triggerfish Hitam',                       desc: 'Ikan herbivora bertaring kuat yang memakan bulu babi dan membantu menjaga keseimbangan terumbu karang.', 
    info:'Ikan yang mempesona adalah salah satu jenis Triggerfish yang paling tidak agresif dan mudah dipelihara di akuarium yang lebih besar. Ikan cerdas ini tidak hanya dapat belajar makan dari tangan Anda, tetapi juga mampu mengeluarkan suara dalam beberapa cara berbeda. Kunci keberhasilan memelihara spesies ini adalah menyediakan ruang berenang yang luas.' },
              ...
              >
                ...
                >
                  <ImageWithSkeleton
                    ...
                    src={item.img}
                    alt={item.name}
                    wrapperClassName="w-full h-[220px] sm:h-[180px] md:h-[180px] xl:h-[200px]"
                ...
                <p className="mt-3 text-white/70 text-sm md:text-[11px] leading-relaxed px-1 line-clamp-2">
                  {item.desc}
                </p>
              </motion.div>
            )
